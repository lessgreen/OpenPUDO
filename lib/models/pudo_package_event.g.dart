...
PudoPackageEvent _$PudoPackageEventFromJson(Map<String, dynamic> json) => PudoPackageEvent(
      packageEventId: json['packageEventId'] as int,
      packageId: json['packageId'] as int,
      createTms: json['createTms'] == null ? null : DateTime.parse(json['createTms'] as String),
...
Map<String, dynamic> _$PudoPackageEventToJson(PudoPackageEvent instance) => <String, dynamic>{
