...
class HomeMapsSearchController extends StatefulWidget {
  ...
  @override
  _HomeMapsSearchControllerState createState() =>
      _HomeMapsSearchControllerState();
}

class _HomeMapsSearchControllerState extends State<HomeMapsSearchController> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Consumer<MapsSearchControllerViewModel?>(
                  ...
                  FlutterMap(
                    ...
                    options: MapOptions(
                      ...
                      onMapCreated: (controller) {
                        viewModel?.onMapCreate(controller, LatLng(40, 9));
