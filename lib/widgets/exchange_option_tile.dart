...
class ExchangeOptionTile extends StatelessWidget {
  ...
  const ExchangeOptionTile({Key? key, required this.value, required this.isNonMultipleActive, required this.onSelect, required this.model, required this.onTextChange}) : super(key: key);
              ...
              child: RichText(
                text: TextSpan(
                  ...
                  children: [
                    ...
                    TextSpan(
                      text: model.name,
                      style: Theme.of(context).textTheme.subtitle1?.copyWith(height: 1.5, letterSpacing: 0),
                    ),
                  ],
                ),
              ),
